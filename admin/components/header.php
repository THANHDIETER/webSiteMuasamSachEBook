...
<body class="text-dark bg-light">
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a href="index.php?act=account" class="nav-link text-light px-3">
            ...
            <a href="logout.php" class="nav-link text-light px-3"><i class="fa-solid fa-gear me-2"></i>Đăng xuất</a>
            ...
            <div class="ms-auto d-flex align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="logout.php" class="nav-link text-light px-3"><i class="fa-solid fa-gear me-2 text-danger"></i>Đăng xuất</a>
                    </ul>
                </div>
            </div>
        </header>
