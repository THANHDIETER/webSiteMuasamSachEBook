                    ...
                    <div class="border p-3 mb-4">
                        ...
                        <ul class="list-unstyled">
                            <?php foreach ($danhmucs as $key): ?>
                                <li><a href="?act=dmid&id=<?= $key['dm_id'] ?>"
                    ...
                    <div class="row">
                        ...
                        <?php foreach ($products as $key): ?>
                            <div class="col-md-3 mb-3">
                                <div class="card">
                                    <img style=" height:280px;  padding: 20px; "
                                        src="./assets/images/prod/books/<?php echo $key['img'] ?>" class="card-img-top"
                                        alt="Về Đi Con - Bìa Cứng">
                                    <div class="card-body">
