...
<body>
    ...
    <div class="bg-light">
        <div style="display: grid; gap:40px;" class="container  ">
            <br>
            <p class="wrapper">Trang chi tiết sản phẩm </p>
            <?php foreach ($productOne as $name): ?>
                <div class="row bg-white">
                    <div class="col-4">
                        <img style=" max-width:100%;" src="./assets/images/prod/books/<?php echo $name['img'] ?>"
                            class="top-pro-img" alt="">
                    </div>
                    ...
                    <div class="col-8">
                        ...
                        <p class="TINHTRANG">Tình trạng: <?php if ($name['quantity'] > 0) {
                            echo 'còn ';
                            echo $name['quantity'];
                            echo ' sản phẩm';
                        } else {
                        ...
                        <a style="width: 200px; height:40px; background-color:red; line-height:40px;"
                            class=" nav-link btn   text-white" href="?act=addToCart&id=<?= $name['id'] ?>">">Thêm vào giỏ
                            hàng</a>
                        <br>
                        ...
                        <div class="overflow-hidden" style="height: 540px;" id="bookList">
                            ...
                            <?php foreach ($top8 as $key): ?>
                                <div class="text-center">
                                    ...
                                    <img style="max-width:100%" src="./assets/images/prod/books/<?php echo $key['img'] ?>"
                                        alt=""></a>
                                    <a class="bg-white nav-link"
                                        href="?act=detail&id=<?php echo $key['id'] ?>"><?php echo $key['name'] ?></a>
                    ...
                    <?php foreach ($top8 as $key): ?>
                        <a class="bg-white nav-link" href="?act=detail&id=<?php echo $key['id'] ?>">
                            <div class="card me-3" style="width: 200px;">
                                <img src="./assets/images/prod/books/<?php echo $key['img'] ?>" class="card-img-top"
                                    alt="Book 1">
        ...
        <div class="container mt-5">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-light btn-sm dropdown-toggle" type="button" id="sortComments"
